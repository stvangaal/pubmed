...
| wp-pages | Phase 3 | in-progress | src/distribute/wp_pages.py, tests/distribute/test_wp_pages.py, content/pages/_defaults/privacy-policy.md, content/pages/_defaults/terms-of-use.md, content/pages/_defaults/disclaimer.md, content/pages/_defaults/about.md, content/pages/_defaults/landing.md, .github/workflows/sync-wp-pages.yml | wp-config |
