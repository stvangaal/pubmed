...
| email-send | Phase 3 | in-progress | src/distribute/email_send.py, src/distribute/subscriber_query.py, tests/distribute/test_email_send.py, config/email-config.yaml | email-digest, email-config |
| digest-archive | Phase 5 | draft | src/distribute/digest_upload.py, infra/supabase/schema.sql, web/ | email-digest, literature-summary |
